...
fun help() {
    ...
    System.out.printf(format, "", "'-> Type in the ip and the subnet like this: 192.168.1.0/24")
    System.out.printf(format, "", "'-> This shows all reachable devices and also if SNMP is active or not")
